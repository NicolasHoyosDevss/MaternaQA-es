...
Uso:
    python scripts/obstetrics/extract_tables.py --input-dir raw_data/obstetrics/spanish --output data/obstetrics_spanish/tables.jsonl
"""
...
from utils import default_data_dir, project_root, slugify, write_jsonl
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", type=Path, default=data_dir / "tables.jsonl")
    parser.add_argument("--report-output", type=Path, default=data_dir / "table_extraction_report.json")
