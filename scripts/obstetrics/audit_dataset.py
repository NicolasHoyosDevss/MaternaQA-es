...
from utils import default_data_dir, load_inventory_manifest, read_jsonl, write_json
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--test", type=Path, default=data_dir / "test_lm.jsonl")
    parser.add_argument("--inventory", type=Path, default=data_dir / "inventory.json")
    parser.add_argument("--table-report", "--tables-report", dest="table_report", type=Path, default=data_dir / "table_extraction_report.json")
